<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="incomplete_orders.aspx.cs" Inherits="_Default" %>
...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
                        <h2>
                            <i class="glyphicon glyphicon-edit"></i>Incompleted Orders</h2>
                    </div>
                    
<asp:GridView ID="grd_incomplete_order" runat="server" AutoGenerateColumns="False" 
